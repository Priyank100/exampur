                      ...
                      CustomAmberButton(onPressed: (){
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(height: 10,),
                                CustomButton(navigateTo:MyApexVideoMaterial(materialList[index].timeline!.apexLink!.hlsUrl.toString(),materialList[index].title.toString(),materialList[index].timeline!.recordingProps!.the240.toString()) ,title: getTranslated(context, StringConstant.Normal),),
                                SizedBox(height: 10,),
                                CustomButton(navigateTo: MyApexVideoMaterial(materialList[index].timeline!.apexLink!.hls240PUrl.toString(),materialList[index].title.toString(),materialList[index].timeline!.recordingProps!.the240.toString()),title: '240p',),
                                SizedBox(height: 10,),
                                CustomButton(navigateTo:MyApexVideoMaterial(materialList[index].timeline!.apexLink!.hls360PUrl.toString(),materialList[index].title.toString(),materialList[index].timeline!.recordingProps!.the360.toString() ),title: '360p',),
                                SizedBox(height: 10,),
                                CustomButton(navigateTo:MyApexVideoMaterial(materialList[index].timeline!.apexLink!.hls480PUrl.toString(),materialList[index].title.toString(),materialList[index].timeline!.recordingProps!.the576.toString(), ),title: '480p',),
                                SizedBox(height: 10,),
                                CustomButton(navigateTo: MyApexVideoMaterial(materialList[index].timeline!.apexLink!.hls720PUrl.toString(),materialList[index].title.toString(),materialList[index].timeline!.recordingProps!.the576.toString(),),title: '720p',),
                                SizedBox(height: 10,),
