  ...
  Widget WatchVideoButton(List<MaterialData> materialList, index) {
    return InkWell(
      onTap: () {
        ...
        AppConstants.timlineId =  materialList[index].timeline == null ? '' :materialList[index].timeline!.id.toString() ;
        AppConstants.timlineName = materialList[index].timeline == null? '':materialList[index].timeline!.title.toString() ;
        materialList[index].timeline == null || materialList[index].timeline!.apexLink == null ?
