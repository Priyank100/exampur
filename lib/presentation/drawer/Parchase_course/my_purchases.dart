    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          children: [
           ...
           isLoading?Center(child: CircularProgressIndicator(color: AppColors.amber,)): mypurchaseList==0?AppConstants.noDataFound(): ListView.builder(itemCount:mypurchaseList.length,
    shrinkWrap: true,
