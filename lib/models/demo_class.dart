...
List<DemoClass> demoClassFromJson(String str) => List<DemoClass>.from(json.decode(str).map((x) => DemoClass.fromJson(x)));

String demoClassToJson(List<DemoClass> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
