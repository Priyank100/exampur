...
List<MyCourseSchedule> myCourseScheduleFromJson(String str) => List<MyCourseSchedule>.from(json.decode(str).map((x) => MyCourseSchedule.fromJson(x)));

String myCourseScheduleToJson(List<MyCourseSchedule> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class MyCourseSchedule {
  ...
  factory MyCourseSchedule.fromJson(Map<String, dynamic> json) => MyCourseSchedule(
